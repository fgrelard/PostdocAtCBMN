...
**** TODO Open new image on the left view only, when gridmode is activated
...
:PROPERTIES:
:ID:       bb088aa9-33fc-4d5a-b2d0-b00d9a4be769
:END:
...
:END:
**** TODO Fix transformation issues with incorrect parameters (position, scale, ...) during partial registration
:LOGBOOK:
CLOCK: [2021-11-08 Mon 16:50]
:END:
