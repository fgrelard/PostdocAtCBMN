...
Registration is usually the first step of multimodal image integration. It consists in aligning two or more images: the moving, or deformable image, onto the fixed, or reference image. 
