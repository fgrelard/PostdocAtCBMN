...
Iconic methods are used in numerous MALDI-MSI registration tasks. [[cite:&Castellanos_Garcia_2021]] combine MALDI-MS with LA-ICP-MS images, so as to combine the quantification made possible by the latter with extensive molecular information from the former.
