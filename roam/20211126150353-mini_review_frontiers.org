...
:PROPERTIES:
:ID:       68e8a3d8-0b8f-4559-9a5e-6678de17af6d
:END:
...
The images should be in the same intensity range.
...
Class discovery can be achieved by data dimension reduction methods or clustering.
...
[[cite:&Wehrli2020-spatial]] Multiblock
