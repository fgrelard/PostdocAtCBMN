...
The variety of processing methods makes it difficult to choose them appropriately. [[cite:&Abdelmoula_2022]] use a deep learning architecture to classify tumor and healthy pixels in MS datasets. This method works directly on the full spectra and requires no pre-processing, such as peak picking and alignment. They  manually transfer annotations from H&E microscopy to create a labelled MS dataset. From this dataset, they learn a lower, non-linear representation of the MSI dataset which is further used for tumor classification. More generally, deep learning could facilitate the processing and joint analysis of MS datasets.
