...
- [[cite:&Nimesh2013-curren]]
  ...
  Overall, current advances are dependent on the field of study, or the application. An overview of current advances of all related methods pertaining to the technique is necessary.
* Future challenges
** Data processing
