...
Landmarks are features in the image that are salient and easily recognizable. They can be selected manually or automatically. For instance, [[cite:&Borodinov_2020]] register MALDI images onto a SIMS image by selecting matching pairs of fiducial markers. 
