...
2) [[cite:&Rumelhart1986-learn]]: back-propagation and training of multi layer perceptron (MLP). Activation function: sigmoid, in order to activate each neuron non linearly.
3) 
