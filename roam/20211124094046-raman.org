...
Simplified as $\sigma$, Raman cross section (intensity+polarizability), $F$ Factor depending on the measurements conditions, $C$ scatterers density (probed volume).

Raman image: pixelized image.
