...
Vibrations d'élongation: variation de la position des atomes le long de leur axes. Elles peuvent être symétriques ou asymétriques
Vibrations de déformations: variation de l'angle formé entre deux liaisons successives

Nombre de vibrations: $3n-6$ et $3n-5$ pour une molécule linéaire.

Analyse qualitative des spectres infrarouges:
#+ATTR_ORG: :width 500
#+CAPTION: Chaque image correspond aux vibrations moléculaires.
